...
namespace SharpMap.Data.Providers.ShapeFile
{
    ...
    internal partial class DbaseFile : IDisposable
    {
        ...
        internal DbaseFile(String fileName, IGeometryFactory geoFactory, Boolean isReadonly)
            : this(fileName, geoFactory, true, isReadonly)
        { }

        private DbaseFile(String fileName, IGeometryFactory geoFactory, Boolean checkExists, Boolean isReadonly)
        {
        ...
        {
            DbaseFile file = new DbaseFile(fileName, geoFactory, false, false);
        ...
        private FileStream openDbfFileStream(Boolean exclusive)
        {
            return new FileStream(_filename,
                                  ...
                                  exclusive ? FileShare.None : IsReadonly ? FileShare.Read : FileShare.None,
                                  4096,
                                  FileOptions.None);
        }
