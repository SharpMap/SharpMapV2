...
{
    public class OLSize : ISerializeToOLJson, IOLClass, IOlJsNewable
    {
        [OLJsonSerialization(SerializedName = "w")]
        public double? Width { get; set; }

        [OLJsonSerialization(SerializedName = "h")]
        ...
        {
            return string.Format("new OpenLayers.Size({0}, {1})", Width, Height);
        }
