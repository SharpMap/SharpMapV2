...
{
    public class OLIcon : ISerializeToOLJson, IOLClass
    {
        [OLJsonSerialization(SerializedName = "url")]
        public string Url { get; set; }

        [OLJsonSerialization(SerializedName = "size")]
        public OLSize Size { get; set; }

        [OLJsonSerialization(SerializedName = "offset")]
        public OLPixel Offset { get; set; }
