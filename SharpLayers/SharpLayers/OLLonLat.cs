...
{
    public class OLLonLat : IOLClass, ISerializeToOLJson, IOlJsNewable
    {
        [OLJsonSerialization(SerializedName = "lon")]
        public double? Lon { get; set; }

        [OLJsonSerialization(SerializedName = "lat")]
        ...
        {
            return string.Format("new OpenLayers.LonLat({0}, {1})", Lon, Lat);
        }
