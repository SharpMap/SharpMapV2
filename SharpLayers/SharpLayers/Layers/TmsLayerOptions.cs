...
{
    public class TmsLayerOptions
        : LayerOptionsBase, IGridBasedLayerOptions
    {
        [OLJsonSerialization(SerializedName = "layername")]
        public string LayerName { get; set; }

        [OLJsonSerialization(SerializedName = "type")]
        public string ImageExtension { get; set; }

        #region IGridBasedLayerOptions Members
        ...
        [OLJsonSerialization(SerializedName = "transitionEffect")]
