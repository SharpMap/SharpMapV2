...
OpenLayers.Map = OpenLayers.Class({
    ...
    */
    ...
    get_serverControls: dummyGet,
    set_serverControls: function(controls) {
        for (var c in controls)
            this.addControl(controls[c]);
    },

    get_serverLayers: dummyGet,
    set_serverLayers: function(layers) {
        this.addLayers(layers);
        this.zoomToMaxExtent();
    },

    get_aaaServerInit: dummyGet,
    set_aaaServerInit: function(init) {
        //init.options.controls = [];
        this.sharplayersInitialize(init.div, init.options);
    },
    initialize: dummyGet,


    sharplayersInitialize: function(div, options) {
...
OpenLayers.registerAspNet(OpenLayers.Map);
