...
{
    public class OLPixel : ISerializeToOLJson, IOLClass, IOlJsNewable
    {
        [OLJsonSerialization(SerializedName = "x")]
        public double? X { get; set; }

        [OLJsonSerialization(SerializedName = "y")]
        ...
        {
            return string.Format("new OpenLayers.Pixel({0}, {1})", X, Y);
        }
