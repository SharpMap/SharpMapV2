...
namespace MapViewer.Commands
{
    ...
    public interface ICommand<TEventArgs>
        : ICommand where TEventArgs : CommandEventArgs
    {
        new event EventHandler<TEventArgs> CommandFired;
        void FireCommand(TEventArgs args);
    }
}