...
{
    public class StdWmsMapConfigFactory : WmsRequestConfigFactoryBase
    {
        private static readonly Capabilities.WmsServiceDescription description =
            new Capabilities.WmsServiceDescription("Acme Corp. Map Server", "http://roadrunner.acmecorp.com/ambush")
            {
                Abstract = @"Map Server maintained by Acme Corporation. Contact: webmaster@wmt.acme.com.
                ...
                ContactInformation = new Capabilities.WmsContactInformation
                {
                    PersonPrimary = new Capabilities.WmsContactInformation.ContactPerson
                    {
                        Person = "John Doe",
                        Organisation = "Acme Inc"
                    },
                    Address = new Capabilities.WmsContactInformation.ContactAddress
                    {
                        AddressType = "postal",
                        Country = "Neverland"
                    },
