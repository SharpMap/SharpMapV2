...
// Modified by John Diss www.newgrove.com 2008
//
...
namespace SharpMap.Presentation.AspNet.WmsServer
{
    ...
    public class Capabilities
    {
            ...
            ///John Diss: added context param. this is required when calling from an async http handler
        {
            ...
            RootNode.AppendChild(GenerateCapabilityNode(context, map, capabilities));
        ...
        private static XmlNode GenerateCapabilityNode(HttpContext context, Map map, XmlDocument capabilities)
        {
            string OnlineResource = "";
            string port = context.Request.Url.IsDefaultPort ? "" : ":" + context.Request.Url.Port;
            OnlineResource =
                context.Server.HtmlEncode("http://" + context.Request.Url.Host + port + context.Request.Url.AbsolutePath);
        ...
        private static XmlSchema GetCapabilitiesSchema()
        {
            ...
            using (Stream stream =
                Assembly.GetExecutingAssembly().GetManifestResourceStream(
                    "SharpMap.Presentation.AspNet.WmsServer.Schemas._1._3._0.capabilities_1_3_0.xsd"))
            {
                schema = XmlSchema.Read(stream, ValidationError);
                stream.Close();
            }
            return schema;
        }
