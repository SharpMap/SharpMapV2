...
namespace ProjNet.CoordinateSystems
{
            ...
            IConvertible
    {
        ...
        {
            return CoordinateSystemWktReader<TCoordinate>.Parse(Wkt) as ICoordinateSystem<TCoordinate>;
        }
        ...
        public ICompoundCoordinateSystem<TCoordinate> CreateCompoundCoordinateSystem(string name, ICoordinateSystem<TCoordinate> head,
        ...
        public IFittedCoordinateSystem<TCoordinate> CreateFittedCoordinateSystem(string name,
                                                                                 ICoordinateSystem<TCoordinate>
                                                                                     baseCoordinateSystem,
                                                                                 string toBaseWkt,
                                                                                 IEnumerable<AxisInfo> axes)
        {
            throw new NotImplementedException();
        }
        ...
        public ILocalCoordinateSystem<TCoordinate> CreateLocalCoordinateSystem(string name, ILocalDatum datum,
                                                                               IUnit unit, IEnumerable<AxisInfo> axes)
        {
            throw new NotImplementedException();
        }
        ...
        public IEllipsoid CreateEllipsoid(string name, double semiMajorAxis, double semiMinorAxis,
                                          ILinearUnit linearUnit)
        {
            return
                new Ellipsoid(semiMajorAxis, semiMinorAxis, 1.0, false, linearUnit, name, String.Empty, -1, String.Empty,
        ...
        /// <returns>Ellipsoid</returns>
        public IEllipsoid CreateFlattenedSphere(string name, double semiMajorAxis, double inverseFlattening,
                                                ILinearUnit linearUnit)
        {
            ...
            return
                new Ellipsoid(semiMajorAxis, -1, inverseFlattening, true, linearUnit, name, String.Empty, -1,
        ...
        public IProjectedCoordinateSystem<TCoordinate> CreateProjectedCoordinateSystem(string name,
                                                                                       IGeographicCoordinateSystem<TCoordinate> gcs,
                                                                                       IProjection projection,
                                                                                       ILinearUnit linearUnit,
                                                                                       AxisInfo axis0, AxisInfo axis1)
        {
            if (String.IsNullOrEmpty(name))
            {
                throw new ArgumentException("Invalid name.");
            ...
            return new ProjectedCoordinateSystem<TCoordinate>(null, gcs, linearUnit, projection, info, name, String.Empty,
        ...
        public IProjection CreateProjection(string name, string wktProjectionClass, IEnumerable<ProjectionParameter> parameters)
        {
            if (string.IsNullOrEmpty(name))
            {
                throw new ArgumentException("Invalid name");
            ...
            return new Projection(wktProjectionClass, paramList,
                name, String.Empty, -1, String.Empty, String.Empty, String.Empty);
        }
        ...
        /// either specify a <see cref="DatumType">horizontalDatumType</see> of <see cref="DatumType.HorizontalOther"/>, or create it via Wkt.
        /// </remarks>
        /// <param name="name">Name of ellipsoid</param>
                                                      ...
                                                      Wgs84ConversionInfo toWgs84)
        {
            ...
            return
                new HorizontalDatum(ellipsoid, toWgs84, datumType, name, String.Empty, -1, String.Empty, String.Empty,
                                    String.Empty);
        }
        ...
        public IPrimeMeridian CreatePrimeMeridian(string name, IAngularUnit angularUnit, double longitude)
        {
            ...
            return
                new PrimeMeridian(longitude, angularUnit, name, String.Empty, -1, String.Empty, String.Empty,
                                  String.Empty);
        }
        ...
        public IGeographicCoordinateSystem<TCoordinate> CreateGeographicCoordinateSystem(string name, IAngularUnit angularUnit,
                                                                            IHorizontalDatum datum,
                                                                            IPrimeMeridian primeMeridian, AxisInfo axis0,
                                                                            AxisInfo axis1)
        {
            if (string.IsNullOrEmpty(name))
            {
            ...
            info.Add(axis1);
            return
                new GeographicCoordinateSystem<TCoordinate>(angularUnit, datum, primeMeridian, info, name, String.Empty, -1,
                                               String.Empty, String.Empty, String.Empty);
        }
        ...
        public IVerticalCoordinateSystem<TCoordinate> CreateVerticalCoordinateSystem(string name, IVerticalDatum datum,
                                                                        ILinearUnit verticalUnit, AxisInfo axis)
        {
            throw new NotImplementedException();
        }
        ...
        public IGeocentricCoordinateSystem<TCoordinate> CreateGeocentricCoordinateSystem(string name, IHorizontalDatum datum,
                                                                            ILinearUnit linearUnit,
                                                                            IPrimeMeridian primeMeridian)
        {
            ...
            return
                new GeocentricCoordinateSystem<TCoordinate>(datum, linearUnit, primeMeridian, info, name, String.Empty, -1,
                                               String.Empty, String.Empty, String.Empty);
        }
