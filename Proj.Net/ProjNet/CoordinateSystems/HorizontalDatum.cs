...
namespace ProjNet.CoordinateSystems
{
    ...
    public class HorizontalDatum : Datum, IHorizontalDatum
    {
            ...
            get
            {
                HorizontalDatum datum =
                    new HorizontalDatum(CoordinateSystems.Ellipsoid.WGS72,
                                        null, DatumType.HorizontalGeocentric, "World Geodetic System 1972", "EPSG", 6322,
                                        String.Empty,
        ...
        public static HorizontalDatum ETRF89
        {
            ...
            {
                HorizontalDatum datum =
                    new HorizontalDatum(CoordinateSystems.Ellipsoid.GRS80, null, DatumType.HorizontalGeocentric,
                                        "European Terrestrial Reference System 1989", "EPSG", 6258, "ETRF89",
            ...
            get
            {
                return
                    new HorizontalDatum(CoordinateSystems.Ellipsoid.International1924,
                                        new Wgs84ConversionInfo(-87, -98, -121, 0, 0, 0, 0), DatumType.HorizontalGeocentric,
