...
namespace ProjNet.Tests
{
    ...
    public class CoordinateTransformTests
    {
        ...
        public void TestAlbersProjection()
        {
            ...
            ICoordinateTransformation trans =
                new CoordinateTransformationFactory<Coordinate2D>(cf, gf, new FakeMatrixFactory())
        ...
        public void TestGeocentric()
        {
            ...
            IGeographicCoordinateSystem<Coordinate2D> gcs =
                cFac.CreateGeographicCoordinateSystem(extents,
                                                      ...
                                                      new AxisInfo(AxisOrientation.North, "North"),
                                                      "ETRF89 Geographic");
            IGeocentricCoordinateSystem gcenCs = cFac.CreateGeocentricCoordinateSystem(extents,
                                                                                       HorizontalDatum
                                                                                           .Etrf89,
                                                                                       LinearUnit.
                                                                                           Meter,
    ...
    internal class FakeMatrixFactory : IMatrixFactory<DoubleComponent>
    {
        ...
        public IAffineTransformMatrix<DoubleComponent> CreateAffineMatrix(MatrixFormat format,
                                                                          Int32 rank)
        {
            return null;
        }

        public IAffineTransformMatrix<DoubleComponent> CreateAffineMatrix(Int32 rank)
        {
            return null;
        }
        ...
        public IMatrix<DoubleComponent> CreateMatrix(MatrixFormat format, Int32 rowCount,
                                                     Int32 columnCount)
        {
            return null;
        }

        public IMatrix<DoubleComponent> CreateMatrix(Int32 rowCount, Int32 columnCount,
                                                     IEnumerable<DoubleComponent> values)
        {
            return null;
        }
        ...
        public ITransformMatrix<DoubleComponent> CreateTransformMatrix(MatrixFormat format,
                                                                       Int32 rowCount,
                                                                       Int32 columnCount)
        {
            return null;
        ...
        public ITransformMatrix<DoubleComponent> CreateTransformMatrix(Int32 rowCount,
                                                                       Int32 columnCount)
        {
            return null;
        }
