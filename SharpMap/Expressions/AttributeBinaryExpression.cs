...
namespace SharpMap.Expressions
{
    public class AttributeBinaryExpression : BinaryExpression
    {
        ...
        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, Int16 value)
            : base(left, op, new LiteralExpression<Int16>(value)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, Int32 value)
            : base(left, op, new LiteralExpression<Int32>(value)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, Int64 value)
            : base(left, op, new LiteralExpression<Int64>(value)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, Single value)
            : base(left, op, new LiteralExpression<Single>(value)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, Double value)
        ...
        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, Guid value)
            : base(left, op, new LiteralExpression<Guid>(value)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, UInt16 value)
            : base(left, op, new LiteralExpression<UInt16>(value)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, UInt32 value)
        ...
        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, Char value)
            : base(left, op, new LiteralExpression<Char>(value)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, Byte value)
        ...
        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, DateTime value)
        ...
        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<Int16> values)
            : base(left, op, new CollectionExpression<Int16>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<Int32> values)
            : base(left, op, new CollectionExpression<Int32>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<Int64> values)
            : base(left, op, new CollectionExpression<Int64>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<Single> values)
            : base(left, op, new CollectionExpression<Single>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<Double> values)
            : base(left, op, new CollectionExpression<Double>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<Decimal> values)
            : base(left, op, new CollectionExpression<Decimal>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<Guid> values)
            : base(left, op, new CollectionExpression<Guid>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<UInt16> values)
            : base(left, op, new CollectionExpression<UInt16>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<UInt32> values)
            : base(left, op, new CollectionExpression<UInt32>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<UInt64> values)
            : base(left, op, new CollectionExpression<UInt64>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<Char> values)
            : base(left, op, new CollectionExpression<Char>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<Byte> values)
            : base(left, op, new CollectionExpression<Byte>(values)) { }

        public AttributeBinaryExpression(PropertyNameExpression left, BinaryOperator op, IEnumerable<SByte> values)
