...
namespace SharpMap.Rendering.Thematics
{
    ...
    public class CustomTheme : ITheme
    {
        ...
        /// The method must take a <see cref="FeatureDataRow"/> and return an <see cref="SharpMap.Styles.IStyle"/>.
        ...
        /// private static SharpMap.Styles.VectorStyle GetCustomStyle(FeatureDataRow row)
        /// {
        /// 
        ...
        /// <code lang="C#">
        /// private static SharpMap.Styles.VectorStyle GetRoadStyle(FeatureDataRow row)
        /// {
        ///		SharpMap.Styles.VectorStyle style = new SharpMap.Styles.VectorStyle();
