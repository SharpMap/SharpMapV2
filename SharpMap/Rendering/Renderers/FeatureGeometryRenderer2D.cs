...
{
	public class FeatureGeometryRenderer2D<TRenderObject> : FeatureRenderer2D<VectorStyle, TRenderObject>
	{
		private VectorRenderer2D<TRenderObject> _vectorRenderer;

		public FeatureGeometryRenderer2D(VectorRenderer2D<TRenderObject> vectorRenderer)
		{
