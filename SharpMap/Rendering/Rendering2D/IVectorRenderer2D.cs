...
namespace SharpMap.Rendering.Rendering2D
{
    ...
    public interface IVectorRenderer2D : IRenderer
    {
        ...
        IEnumerable RenderPaths(IEnumerable<GraphicsPath2D> paths, StylePen outline,
        ...
        /// <returns>A rendered object suitable for direct display.</returns>
        IEnumerable RenderPaths(IEnumerable<GraphicsPath2D> paths,
        ...
        /// <param name="selectOutline">Style of the path outline when selected.</param>
        /// <returns>A rendered object suitable for direct display.</returns>
        IEnumerable RenderPaths(IEnumerable<GraphicsPath2D> path, StyleBrush fill,
