...
namespace SharpMap.Coordinates
{
    public class BufferedCoordinateSequence : ICoordinateSequence<BufferedCoordinate2D>
    {
        ...
        public void Sort(int start, int end, IComparer<BufferedCoordinate2D> comparer)
        {
            throw new NotImplementedException();
        }
        ...
        #region IComparable<ICoordinateSequence<BufferedCoordinate2D>> Members

        public int CompareTo(ICoordinateSequence<BufferedCoordinate2D> other)
        {
            throw new NotImplementedException();
        }
        ...
        #region IEquatable<ICoordinateSequence<BufferedCoordinate2D>> Members

        public bool Equals(ICoordinateSequence<BufferedCoordinate2D> other)
        {
            throw new NotImplementedException();
        }
