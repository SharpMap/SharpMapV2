	...
	public class LinearUnit : Info, ILinearUnit
	{
		...
		public override string Wkt
		{
			get
			{
                ...
                sb.AppendFormat(SharpMap.Map.Map.NumberFormat_EnUS, "UNIT[\"{0}\", {1}", Name, MetersPerUnit);
		...
		public override string Xml
		{
			get
			{
                return String.Format(SharpMap.Map.Map.NumberFormat_EnUS, "<CS_LinearUnit MetersPerUnit=\"{0}\">{1}</CS_LinearUnit>", MetersPerUnit, InfoXml);
			}
		}
