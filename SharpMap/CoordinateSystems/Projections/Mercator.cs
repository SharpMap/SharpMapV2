...
namespace SharpMap.CoordinateSystems.Projections
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>This map projection introduced in 1569 by Gerardus Mercator. 
    ...
    /// are parallel, horizontal straight lines, spaced farther and farther apart as their distance
    /// from the Equator increases. This projection is widely used for navigation charts, because 
    /// any straight line on a Mercator-projection map is a line of constant true bearing that 
    /// enables a navigator to plot a straight-line course. It is less practical for world maps 
    /// because the scale is distorted; areas farther away from the equator appear disproportionately 
    /// large. On a Mercator projection, for example, the landmass of Greenland appears to be
    /// greater than that of the continent of South America; in actual area, Greenland is smaller 
    ...
    internal class Mercator : MapProjection
    {
        ...
        /// <item>
        ///     <term>longitude_of_natural_origin</term>
        ///     <description>
        ...
        ///         application of false coordinates has grid coordinates of (0,0).  Sometimes 
        ///         known as ""central meridian"".
        ///     </description>
        /// </item>
        /// <item>
        ///     <term>latitude_of_natural_origin</term>
        ///     <description>
        ///         The latitude of the point from which the values of both the geographical coordinates 
        ///         on the ellipsoid and the grid coordinates on the projection are deemed to increment 
        ///         or decrement for computational purposes. Alternatively it may be considered as the 
        ///         latitude of the point which in the absence of application of false coordinates has 
        ///         grid coordinates of (0,0).
        ///     </description>
        /// </item>
        /// <item>
        ///     <term>scale_factor_at_natural_origin</term>
        ///     <description>
        ...
        public override SharpMap.Geometries.Point DegreesToMeters(SharpMap.Geometries.Point lonlat)
        {
            ...
            {
                throw new ProjectionComputationException("Transformation cannot be computed at the poles.");
            }
            else
            {
