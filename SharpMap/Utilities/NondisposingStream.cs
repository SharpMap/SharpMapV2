...
namespace SharpMap.Utilities
{
    ...
    /// <see cref="MemoryStream"/> or other lightweight, reusable stream, since the BinaryReader
    /// will dispose this stream, and not the underlying stream, allowing it to be repositioned and reused.
    /// </remarks>
