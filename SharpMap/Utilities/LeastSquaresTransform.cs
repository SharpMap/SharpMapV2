...
namespace SharpMap.Utilities
{
	...
	public class LeastSquaresTransform
	{
		...
		{
			if(inputs.Count<3)
				throw new InvalidOperationException("At least 3 measurements required to calculate affine transformation");
		...
		{
			if (inputs.Count < 2)
				throw new InvalidOperationException("At least 2 measurements required to calculate helmert transformation");
