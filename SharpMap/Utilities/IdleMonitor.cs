...
namespace SharpMap.Utilities
{
	public class IdleMonitor : IDisposable
	{
		...
		public int CheckIdleFrequencyInSeconds
		{
			...
			set
			{
				Interlocked.Exchange(ref _checkIdleFrequencyInSeconds, value);
			}
		}
		...
		public int MachineIdleThresholdInSeconds
		{
			...
			set
			{
				if (value < 0)
				{
					throw new ArgumentOutOfRangeException("value", value, "MachineIdleThresholdInSeconds cannot be negative.");
				}
...
#pragma warning restore 420
		...
		static extern bool GetLastInputInfo(ref LastInputInfo lastInput);
