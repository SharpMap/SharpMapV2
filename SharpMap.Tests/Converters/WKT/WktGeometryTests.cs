...
namespace SharpMap.Tests.Converters.Wkt
{
	...
	public class WktGeometryTests
	{
		...
		public void ParseGeometryCollection()
		{
			...
			geom = Geometry.FromText(geomCollection) as GeometryCollection;
			Assert.IsNotNull(geom);
		...
		public void ParseMultipolygon()
		{
			...
			geom = Geometry.FromText("MULTIPOLYGON (((0 0, 10 0, 10 10, 0 10, 0 0)), EMPTY, ((5 5, 7 5, 7 7, 5 7, 5 5)))") as MultiPolygon;
			Assert.IsNotNull(geom);
			Assert.IsTrue(geom[1].IsEmpty());
		...
		public void ParseMultiLineString()
		{
			...
			geom = Geometry.FromText("MULTILINESTRING ((10 10, 40 50), (20 20, 30 20), EMPTY, (20 20, 50 20, 50 60, 20 20))") as MultiLineString;
			Assert.IsNotNull(geom);
