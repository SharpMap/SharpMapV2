    ...
    public class ByteEncoderTests
    {
        ...
        public void ReversingByteOrderOfDoublesShouldBeReversed()
        {
            if (BitConverter.IsLittleEndian)
            {
                ...
                Assert.AreEqual(Double.PositiveInfinity, ByteEncoder.GetBigEndian(ByteEncoder.GetBigEndian(Double.PositiveInfinity)));
                Assert.AreEqual(Double.NegativeInfinity, ByteEncoder.GetBigEndian(ByteEncoder.GetBigEndian(Double.NegativeInfinity)));
            ...
            else
            {
                ...
                Assert.AreEqual(Double.MinValue, ByteEncoder.GetLittleEndian(ByteEncoder.GetLittleEndian(Double.MinValue)));
                Assert.AreEqual(Double.MaxValue, ByteEncoder.GetLittleEndian(ByteEncoder.GetLittleEndian(Double.MaxValue)));
                Assert.AreEqual(Double.PositiveInfinity, ByteEncoder.GetLittleEndian(ByteEncoder.GetLittleEndian(Double.PositiveInfinity)));
                Assert.AreEqual(Double.NegativeInfinity, ByteEncoder.GetLittleEndian(ByteEncoder.GetLittleEndian(Double.NegativeInfinity)));
