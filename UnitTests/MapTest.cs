...
namespace UnitTests
{
    ...
    public class MapTest
    {
        ...
        public void Initalize_MapInstance()
        {
            ...
            Assert.AreEqual(100f, mapView.ViewPort.Width);
            Assert.AreEqual(100f, mapView.ViewPort.Height);
            Assert.AreEqual(System.Drawing.Color.Transparent, mapv.BackColor);
        ...
        public void FindLayerByPredicate()
        {
            ...
            foreach (ILayer layer in map.Layers.Find(delegate(ILayer match) 
            { 
        ...
        public void SetMinimumZoom_NegativeValue_ThrowException()
        {
            ...
            mapView.ViewPort.MinimumZoom = -1;
        }
        [Test]
        [ExpectedException(typeof(ArgumentException))]
        public void SetMaximumZoom_NegativeValue_ThrowException()
        {
            ...
            mapView.ViewPort.MaximumZoom = -1;
        }
        ...
        public void SetMaximumZoom_OKValue()
        {
            ...
            mapView.ViewPort.MaximumZoom = 100.3;
        ...
        public void SetMinimumZoom_OKValue()
        {
            ...
            mapView.ViewPort.MinimumZoom = 100.3;
        ...
        public void SetZoom_ValueOutsideMax()
        {
            ...
            mapView.ViewPort.MaximumZoom = 100;
            mapView.ViewPort.Zoom = 150;
            Assert.AreEqual(100, mapView.ViewPort.MaximumZoom);
        }
        ...
        {
            SharpMap.Map.Map map = new SharpMap.Map.Map(new System.Drawing.Size(400, 200));
        ...
        {
            SharpMap.Map map = new SharpMap.Map.Map();
            map.Layers.Add(new SharpMap.Layers.VectorLayer("Layer 1"));
            map.GetMap();
        }
        ...
        {
            SharpMap.Map.Map map = new SharpMap.Map.Map(new System.Drawing.Size(500, 200));
