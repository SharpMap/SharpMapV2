...
{
    public class OgrFeatureDataReader : OgrFeatureDataRecord, IFeatureDataReader
    {
        ...
        public OgrFeatureDataReader(OgrProvider provider, FeatureQueryExpression query, FeatureQueryExecutionOptions options)
            :base(provider.GeometryFactory, provider.CoordinateTransformation, Encoding.UTF8, provider.OgrFeatureDefn )
        {
        ...
        private static string OidCollectionExpressionToOgr(OidCollectionExpression oidPredicate)
        {
            ...
            return string.Format("FID IN({0})", builder);
        }
