...
namespace SharpMap.Data.Providers
{
    ...
    /// </para>
    /// <para>
    /// Use <see cref="OgrForSharpMap"/> to configure the gdal environment.
    /// </para>
    /// <example>
    ...
    /// </example>
    ///</remarks>
    static class OgrForSharpMap
    {
        static OgrForSharpMap()
        {
        ...
        private static void SetEnvPath(string variable, string directoryPath, bool ifExists)
        {
            ...
            {
                if (ifExists) return;
                throw new OgrPathException(variable, directoryPath);
            }
            ...
            foreach (string path in paths)
            {
                ...
                {
                    if (!ifExists)
                        throw new OgrPathException(variable, path);
                }
            }
        ...
        private static void PrependToPathIfReqired(String directoryPath)
        {
            ...
            if (String.IsNullOrEmpty(directoryPath))
                throw new OgrPathException("PATH", directoryPath);
        ...
        public class OgrPathException : Exception
        {
            public OgrPathException(string variable, string path)
                : base(
