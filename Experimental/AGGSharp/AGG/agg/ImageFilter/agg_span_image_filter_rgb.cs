...
using image_filter_scale_e = AGG.ImageFilter.FilterScale;
using image_subpixel_scale_e = AGG.ImageFilter.SubPixelScale;

namespace AGG.ImageFilter
{
    //===============================================span_image_filter_rgb_nn
    public class SpanImageFilterRgbNN<T> : SpanImageFilter<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        ...
        //--------------------------------------------------------------------
        public SpanImageFilterRgbNN(IRasterBufferAccessor src, ISpanInterpolator<T> inter)
            : base(src, inter, null)
        {
        ...
        public unsafe override void Generate(RGBA_Bytes* span, int x, int y, uint len)
        {
            ...
            do
            {
                ...
                //(*span).A = 255;
                (*span) = new RGBA_Bytes(fg_ptr[OrderR], fg_ptr[OrderG], fg_ptr[OrderB], 255);
    ...
    public class SpanImageFilterRgbBilinear<T> : SpanImageFilter<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        private int OrderR;
        private int OrderG;
        ...
        public override unsafe void Generate(RGBA_Bytes* span, int x, int y, uint len)
        {
            ...
            unchecked
            {
                do
                {
                    ...
                    (*span) = new RGBA_Bytes((byte)fg[OrderR], (byte)fg[OrderG], (byte)fg[OrderB], (byte)src_alpha);
                    ++span;
                    spanInterpolator.Next();
    ...
    public class SpanImageFilterRgbBilinearClip<T> : SpanImageFilter<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        private int OrderR;
        private int OrderG;
    ...
    public class SpanImageFilterRgb<T> : SpanImageFilter<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        private int OrderR;
        private int OrderG;
    ...
    public class SpanImageFilterRgb2x2<T> : SpanImageFilter<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        private int OrderR;
        private int OrderG;
    ...
    public class span_image_resample_rgb<T>
        : SpanImageResample<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        private int OrderR;
        ...
        private int OrderB;
        private const int BaseMask = 255;
        private const int DownscaleShift = (int)FilterScale.Shift;
