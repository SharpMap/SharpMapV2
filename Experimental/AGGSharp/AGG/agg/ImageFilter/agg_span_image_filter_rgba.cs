...
namespace AGG.ImageFilter
{
    ...
    public class SpanImageFilterRgbaNN<T> : SpanImageFilter<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        ...
        public SpanImageFilterRgbaNN(IRasterBufferAccessor src, ISpanInterpolator<T> inter)
            : base(src, inter, null)
        {
    ...
    public class SpanImageFilterRgbaBilinear<T> : SpanImageFilter<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        private int OrderR;
        private int OrderG;
        ...
        public SpanImageFilterRgbaBilinear(IRasterBufferAccessor src, ISpanInterpolator<T> inter)
            : base(src, inter, null)
        {
            OrderR = src.PixelFormat.Blender.OrderR;
            OrderG = src.PixelFormat.Blender.OrderG;
    ...
    public class SpanImageFilterRgbaBilinearClip<T> : SpanImageFilter<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        private int OrderR;
        private int OrderG;
        ...
        public SpanImageFilterRgbaBilinearClip(IRasterBufferAccessor src,
            IColorType back_color, ISpanInterpolator<T> inter)
            : base(src, inter, null)
        {
    ...
    public class span_image_resample_rgba<T>
        : SpanImageResample<T>
         where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        private int OrderR;
        ...
        private const int downscale_shift = (int)FilterScale.Shift;
