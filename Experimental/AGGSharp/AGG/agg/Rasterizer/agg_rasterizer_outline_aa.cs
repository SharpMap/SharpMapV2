...
namespace AGG.Rasterizer
{
    ...
    public class rasterizer_outline_aa
    {
        ...
        public bool line_join() const { return m_line_join; }
        ...
        //------------------------------------------------------------------------
        public void add_vertex(double x, double y, unsigned cmd)
        {
            if(is_move_to(cmd)) 
            {
                render(false);
        ...
        public void add_path(VertexSource& vs, unsigned path_id=0)
        {
            double x;
            double y;
