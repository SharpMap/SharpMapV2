...
namespace Tesselate
{
        ...
        where T : IEquatable<T>, IComparable<T>, IComputable<T>, IConvertible, IFormattable, ICommonNumericalOperations<T>, ITrigonometricOperations<T>
    {
        ...
        public Face<T> nextFace;		/* next face (never null) */
        public Face<T> prevFace;		/* previous face (never null) */
        public HalfEdge<T> halfEdgeThisIsLeftFaceOf;	/* a half edge with this left face */

        /* Internal data (keep hidden) */
        public Face<T> trail;		/* "stack" for conversion to strips */
        ...
        */
        ...
        public static void AddToTrail(ref Face<T> f, ref Face<T> t)
        {
            f.trail = t;
        ...
        static public void FreeTrail(ref Face<T> t)
        {
            while (t != null)
            {
                t.marked = false;
