...
namespace Tesselate
{
    ...
    {
        public ContourVertex<T> vertexHead = new ContourVertex<T>();		/* dummy header for vertex list */
        public Face<T> faceHead = new Face<T>();		/* dummy header for face list */
        public HalfEdge<T> halfEdgeHead = new HalfEdge<T>();		/* dummy header for edge list */
        HalfEdge<T> otherHalfOfThisEdgeHead = new HalfEdge<T>();	/* and its symmetric counterpart */
        ...
        */
        public Mesh()
        {
            HalfEdge<T> otherHalfOfThisEdge = this.otherHalfOfThisEdgeHead;
        ...
        */
        ...
        static void MakeFace(Face<T> newFace, HalfEdge<T> eOrig, Face<T> fNext)
        {
            HalfEdge<T> e;
            Face<T> fPrev;
            Face<T> fNew = newFace;
        ...
        public HalfEdge<T> MakeEdge()
        {
            ContourVertex<T> newVertex1 = new ContourVertex<T>();
            ContourVertex<T> newVertex2 = new ContourVertex<T>();
            Face<T> newFace = new Face<T>();
            HalfEdge<T> e;
        ...
        */
        static void MakeVertex(ContourVertex<T> newVertex, HalfEdge<T> eOrig, ContourVertex<T> vNext)
        {
            HalfEdge<T> e;
            ContourVertex<T> vPrev;
            ContourVertex<T> vNew = newVertex;
        ...
        */
        static void KillVertex(ContourVertex<T> vDel, ContourVertex<T> newOrg)
        {
            HalfEdge<T> e, eStart = vDel.edgeThisIsOriginOf;
            ContourVertex<T> vPrev, vNext;
        ...
        */
        static void KillFace(Face<T> fDel, Face<T> newLface)
        {
            HalfEdge<T> e, eStart = fDel.halfEdgeThisIsLeftFaceOf;
            Face<T> fPrev, fNext;
        ...
        */
        static void Splice(HalfEdge<T> a, HalfEdge<T> b)
        {
            HalfEdge<T> aOnext = a.nextEdgeCCWAroundOrigin;
            HalfEdge<T> bOnext = b.nextEdgeCCWAroundOrigin;
        ...
        */
        public static void meshSplice(HalfEdge<T> eOrg, HalfEdge<T> eDst)
        {
            ...
            if (!joiningVertices)
            {
                ContourVertex<T> newVertex = new ContourVertex<T>();
        ...
        */
        static void KillEdge(HalfEdge<T> eDel)
        {
            HalfEdge<T> ePrev, eNext;
        ...
        */
        public static void DeleteHalfEdge(HalfEdge<T> edgeToDelete)
        {
            HalfEdge<T> otherHalfOfEdgeToDelete = edgeToDelete.otherHalfOfThisEdge;
            bool joiningLoops = false;
        ...
        * eOrg and eNew will have the same left face.
        */
        static HalfEdge<T> meshAddEdgeVertex(HalfEdge<T> eOrg)
        {
            HalfEdge<T> eNewSym;
            HalfEdge<T> eNew = MakeEdge(eOrg);
        ...
        * eOrg and eNew will have the same left face.
        */
        public static HalfEdge<T> meshSplitEdge(HalfEdge<T> eOrg)
        {
            HalfEdge<T> eNew;
            HalfEdge<T> tempHalfEdge = meshAddEdgeVertex(eOrg);
        ...
        */
        class EdgePair
        {
            public HalfEdge<T> e = new HalfEdge<T>();
            public HalfEdge<T> eSym = new HalfEdge<T>();
        ...
        */
        static HalfEdge<T> MakeEdge(HalfEdge<T> eNext)
        {
            HalfEdge<T> ePrev;
        ...
        */
        public static HalfEdge<T> meshConnect(HalfEdge<T> eOrg, HalfEdge<T> eDst)
        {
            HalfEdge<T> eNewSym;
            bool joiningLoops = false;
            HalfEdge<T> eNew = MakeEdge(eOrg);
        ...
        * both meshes, and returns the new mesh (the old meshes are destroyed).
        */
        Mesh<T> meshUnion(Mesh<T> mesh1, Mesh<T> mesh2)
        {
            Face<T> f1 = mesh1.faceHead;
            ContourVertex<T> v1 = mesh1.vertexHead;
            HalfEdge<T> e1 = mesh1.halfEdgeHead;
            Face<T> f2 = mesh2.faceHead;
            ContourVertex<T> v2 = mesh2.vertexHead;
            HalfEdge<T> e2 = mesh2.halfEdgeHead;
        ...
        * in any order.  Zapped faces cannot be used in further mesh operations!
        */
        public static void meshZapFace(Face<T> fZap)
        {
            HalfEdge<T> eStart = fZap.halfEdgeThisIsLeftFaceOf;
            HalfEdge<T> e, eNext, eSym;
            Face<T> fPrev, fNext;
