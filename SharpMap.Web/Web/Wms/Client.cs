...
namespace SharpMap.Web.Wms
{
	...
	public class Client
	{
		...
		private XmlDocument GetRemoteXml(string Url, System.Net.WebProxy proxy)
		{
			...
			{
				throw new System.Net.WebException("Could not download capabilities", ex);
			}
		}
		...
		private void ParseCapabilities(XmlDocument doc)
		{
			if (doc.DocumentElement.Attributes["version"] != null)
			{
				...
				if (_WmsVersion != "1.0.0" && _WmsVersion != "1.1.0" && _WmsVersion != "1.1.1" && _WmsVersion != "1.3.0")
					throw new NotSupportedException("WMS Version " + _WmsVersion + " not supported");
				...
				throw new InvalidOperationException("No service version number found!");
			...
			if (xnService != null)
                ...
                throw new InvalidOperationException("No service tag found!");
			...
			if (xnCapability != null)
                ...
                throw new InvalidOperationException("No capability tag found!");
		}
