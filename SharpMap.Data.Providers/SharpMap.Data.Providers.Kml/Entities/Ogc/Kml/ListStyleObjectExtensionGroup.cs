...
{
    [XmlRoot(ElementName = "ListStyleObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class ListStyleObjectExtensionGroup
    {
