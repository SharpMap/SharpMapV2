...
{
    [XmlRoot(ElementName = "PolygonObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class PolygonObjectExtensionGroup
    {
