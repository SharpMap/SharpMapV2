...
{
    [XmlRoot(ElementName = "ResourceMapObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false
        ), Serializable]
    public abstract class ResourceMapObjectExtensionGroup
    {
