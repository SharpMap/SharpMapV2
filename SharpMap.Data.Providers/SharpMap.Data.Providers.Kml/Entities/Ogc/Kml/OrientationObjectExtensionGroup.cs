...
{
    [XmlRoot(ElementName = "OrientationObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false
        ), Serializable]
    public abstract class OrientationObjectExtensionGroup
    {
