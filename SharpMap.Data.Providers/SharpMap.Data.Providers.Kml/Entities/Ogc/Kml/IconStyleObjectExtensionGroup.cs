...
{
    [XmlRoot(ElementName = "IconStyleObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class IconStyleObjectExtensionGroup
    {
