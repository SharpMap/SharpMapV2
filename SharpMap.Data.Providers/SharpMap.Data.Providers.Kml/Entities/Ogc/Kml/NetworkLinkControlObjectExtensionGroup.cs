...
{
    [XmlRoot(ElementName = "NetworkLinkControlObjectExtensionGroup", Namespace = Declarations.SchemaVersion,
        IsNullable = false), Serializable]
    public abstract class NetworkLinkControlObjectExtensionGroup
    {
