...
{
    [XmlRoot(ElementName = "AbstractTimePrimitiveObjectExtensionGroup", Namespace = Declarations.SchemaVersion,
        IsNullable = false), Serializable]
    public abstract class AbstractTimePrimitiveObjectExtensionGroup
    {
