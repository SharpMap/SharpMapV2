...
{
    [XmlRoot(ElementName = "AbstractLatLonBoxObjectExtensionGroup", Namespace = Declarations.SchemaVersion,
        IsNullable = false), Serializable]
    public abstract class AbstractLatLonBoxObjectExtensionGroup
    {
