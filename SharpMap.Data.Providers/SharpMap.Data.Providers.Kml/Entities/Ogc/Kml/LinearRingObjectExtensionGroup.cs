...
{
    [XmlRoot(ElementName = "LinearRingObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false)
    , Serializable]
    public abstract class LinearRingObjectExtensionGroup
    {
