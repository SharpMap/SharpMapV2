...
{
    [XmlRoot(ElementName = "AbstractSubStyleObjectExtensionGroup", Namespace = Declarations.SchemaVersion,
        IsNullable = false), Serializable]
    public abstract class AbstractSubStyleObjectExtensionGroup
    {
