...
{
    [XmlRoot(ElementName = "TimeStampObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class TimeStampObjectExtensionGroup
    {
