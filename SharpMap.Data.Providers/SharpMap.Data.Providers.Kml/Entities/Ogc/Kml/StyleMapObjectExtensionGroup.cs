...
{
    [XmlRoot(ElementName = "StyleMapObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class StyleMapObjectExtensionGroup
    {
