...
{
    [XmlRoot(ElementName = "AbstractContainerObjectExtensionGroup", Namespace = Declarations.SchemaVersion,
        IsNullable = false), Serializable]
    public abstract class AbstractContainerObjectExtensionGroup
    {
