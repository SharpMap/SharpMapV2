...
{
    [XmlRoot(ElementName = "BoundaryObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class BoundaryObjectExtensionGroup
    {
