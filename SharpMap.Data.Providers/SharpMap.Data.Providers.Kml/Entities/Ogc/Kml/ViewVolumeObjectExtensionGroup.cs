...
{
    [XmlRoot(ElementName = "ViewVolumeObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false)
    , Serializable]
    public abstract class ViewVolumeObjectExtensionGroup
    {
