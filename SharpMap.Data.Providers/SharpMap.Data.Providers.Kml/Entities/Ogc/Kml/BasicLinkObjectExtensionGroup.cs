...
{
    [XmlRoot(ElementName = "BasicLinkObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class BasicLinkObjectExtensionGroup
    {
