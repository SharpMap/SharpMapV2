...
{
    [XmlRoot(ElementName = "LatLonBoxObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class LatLonBoxObjectExtensionGroup
    {
