...
{
    [XmlRoot(ElementName = "AbstractGeometryObjectExtensionGroup", Namespace = Declarations.SchemaVersion,
        IsNullable = false), Serializable]
    public abstract class AbstractGeometryObjectExtensionGroup
    {
