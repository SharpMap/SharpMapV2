...
{
    [XmlRoot(ElementName = "PolyStyleObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class PolyStyleObjectExtensionGroup
    {
