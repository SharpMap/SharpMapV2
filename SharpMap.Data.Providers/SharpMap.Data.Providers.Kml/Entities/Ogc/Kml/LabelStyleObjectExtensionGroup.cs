...
{
    [XmlRoot(ElementName = "LabelStyleObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false)
    , Serializable]
    public abstract class LabelStyleObjectExtensionGroup
    {
