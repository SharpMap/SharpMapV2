...
{
    [XmlRoot(ElementName = "LineStyleObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class LineStyleObjectExtensionGroup
    {
