...
{
    [XmlRoot(ElementName = "ItemIconObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class ItemIconObjectExtensionGroup
    {
