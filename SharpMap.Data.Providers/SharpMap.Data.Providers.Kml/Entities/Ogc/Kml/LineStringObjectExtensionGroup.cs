...
{
    [XmlRoot(ElementName = "LineStringObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false)
    , Serializable]
    public abstract class LineStringObjectExtensionGroup
    {
