...
{
    [XmlRoot(ElementName = "NetworkLinkObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false
        ), Serializable]
    public abstract class NetworkLinkObjectExtensionGroup
    {
