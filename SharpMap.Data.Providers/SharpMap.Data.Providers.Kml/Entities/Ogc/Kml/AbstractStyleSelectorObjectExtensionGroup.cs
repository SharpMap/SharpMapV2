...
{
    [XmlRoot(ElementName = "AbstractStyleSelectorObjectExtensionGroup", Namespace = Declarations.SchemaVersion,
        IsNullable = false), Serializable]
    public abstract class AbstractStyleSelectorObjectExtensionGroup
    {
