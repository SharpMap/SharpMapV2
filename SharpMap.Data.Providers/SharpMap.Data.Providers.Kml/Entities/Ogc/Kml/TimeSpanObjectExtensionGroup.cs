...
{
    [XmlRoot(ElementName = "TimeSpanObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class TimeSpanObjectExtensionGroup
    {
