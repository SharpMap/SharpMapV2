...
{
    [XmlRoot(ElementName = "DocumentObjectExtensionGroup", Namespace = Declarations.SchemaVersion, IsNullable = false),
     Serializable]
    public abstract class DocumentObjectExtensionGroup
    {
