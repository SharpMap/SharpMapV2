...
namespace SharpMap.Entities.Ogc.Kml
{
    /// <remarks/>
    [Serializable]
    [XmlType(TypeName = "ScreenOverlayType", Namespace = "http://www.opengis.net/kml/2.2")]
    [XmlRoot("ScreenOverlay", Namespace = "http://www.opengis.net/kml/2.2", IsNullable = false)]
    public class ScreenOverlay : OverlayBase
    {
        private Vector2 overlayXYField;

        private double rotationField;

        private bool rotationFieldSpecified;
        private Vector2 rotationXYField;

        private KmlObjectBase[] screenOverlayObjectExtensionGroupField;
        private string[] screenOverlaySimpleExtensionGroupField;
        private Vector2 screenXYField;
        ...
        public KmlObjectBase[] ScreenOverlayObjectExtensionGroup
        {
