...
namespace SharpMap.Entities.Ogc.Kml
{
    ...
    [Serializable]
    [XmlType(TypeName = "AbstractStyleSelectorType", Namespace = "http://www.opengis.net/kml/2.2")]
    public abstract class StyleSelectorBase : KmlObjectBase
    {
        private KmlObjectBase[] _kmlStyleSelectorObjectExtensionGroupField;
        ...
        public KmlObjectBase[] KmlStyleSelectorObjectExtensionGroup
        {
            get { return _kmlStyleSelectorObjectExtensionGroupField; }
            set { _kmlStyleSelectorObjectExtensionGroupField = value; }
        }
    }
}