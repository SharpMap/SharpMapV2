...
namespace SharpMap.Entities.Ogc.Kml
{
    ...
    [Serializable]
    [XmlType(TypeName = "AbstractViewType", Namespace = "http://www.opengis.net/kml/2.2")]
    public abstract class ViewBase : KmlObjectBase
    {
        private KmlObjectBase[] _kmlViewObjectExtensionGroupField;
        ...
        public KmlObjectBase[] KmlViewObjectExtensionGroup
        {
            get { return _kmlViewObjectExtensionGroupField; }
            set { _kmlViewObjectExtensionGroupField = value; }
        }
    }
}