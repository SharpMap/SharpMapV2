...
namespace SharpMap.Entities.Ogc.Kml
{
    /// <remarks/>
    [Serializable]
    [XmlType(TypeName = "OrientationType", Namespace = "http://www.opengis.net/kml/2.2")]
    [XmlRoot("Orientation", Namespace = "http://www.opengis.net/kml/2.2", IsNullable = false)]
    public class Orientation : KmlObjectBase
    {
        private double headingField;

        private bool headingFieldSpecified;
        private KmlObjectBase[] orientationObjectExtensionGroupField;
        ...
        public KmlObjectBase[] OrientationObjectExtensionGroup
        {
