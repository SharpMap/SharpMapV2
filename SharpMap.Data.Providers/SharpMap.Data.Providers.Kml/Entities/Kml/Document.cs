...
namespace SharpMap.Entities.Ogc.Kml
{
    /// <remarks/>
    [Serializable]
    [XmlType(TypeName = "DocumentType", Namespace = "http://www.opengis.net/kml/2.2")]
    [XmlRoot("Document", Namespace = "http://www.opengis.net/kml/2.2", IsNullable = false)]
    public class Document : ContainerBase
    {
        private KmlObjectBase[] documentObjectExtensionGroupField;
        private string[] documentSimpleExtensionGroupField;
        private FeatureBase[] itemsField;
        ...
        public KmlObjectBase[] DocumentObjectExtensionGroup
        {
