...
namespace SharpMap.Entities.Ogc.Kml
{
    /// <remarks/>
    [Serializable]
    [XmlType(TypeName = "ResourceMapType", Namespace = "http://www.opengis.net/kml/2.2")]
    [XmlRoot("ResourceMap", Namespace = "http://www.opengis.net/kml/2.2", IsNullable = false)]
    public class ResourceMap : KmlObjectBase
    {
        private Alias[] aliasField;

        private KmlObjectBase[] resourceMapObjectExtensionGroupField;
        ...
        public KmlObjectBase[] ResourceMapObjectExtensionGroup
        {
