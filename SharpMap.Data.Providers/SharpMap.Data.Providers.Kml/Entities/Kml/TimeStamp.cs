...
namespace SharpMap.Entities.Ogc.Kml
{
    /// <remarks/>
    [Serializable]
    [XmlType(TypeName = "TimeStampType", Namespace = "http://www.opengis.net/kml/2.2")]
    [XmlRoot("TimeStamp", Namespace = "http://www.opengis.net/kml/2.2", IsNullable = false)]
    public class TimeStamp : TimePrimitiveBase
    {
        private KmlObjectBase[] timeStampObjectExtensionGroupField;
        ...
        public KmlObjectBase[] TimeStampObjectExtensionGroup
        {
