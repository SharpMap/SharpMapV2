...
namespace SharpMap.Entities.Ogc.Kml
{
    /// <remarks/>
    [Serializable]
    [XmlType(TypeName = "FolderType", Namespace = "http://www.opengis.net/kml/2.2")]
    [XmlRoot("Folder", Namespace = "http://www.opengis.net/kml/2.2", IsNullable = false)]
    public class Folder : ContainerBase
    {
        private KmlObjectBase[] folderObjectExtensionGroupField;
        ...
        public KmlObjectBase[] FolderObjectExtensionGroup
        {
