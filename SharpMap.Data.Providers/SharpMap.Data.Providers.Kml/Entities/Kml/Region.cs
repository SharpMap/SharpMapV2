...
namespace SharpMap.Entities.Ogc.Kml
{
    /// <remarks/>
    [Serializable]
    [XmlType(TypeName = "RegionType", Namespace = "http://www.opengis.net/kml/2.2")]
    [XmlRoot("Region", Namespace = "http://www.opengis.net/kml/2.2", IsNullable = false)]
    public class Region : KmlObjectBase
    {
        private LatLonAltBox latLonAltBoxField;

        private Lod lodField;

        private KmlObjectBase[] regionObjectExtensionGroupField;
        ...
        public KmlObjectBase[] RegionObjectExtensionGroup
        {
