...
namespace SharpMap.Entities.Ogc.Kml
{
    /// <remarks/>
    [Serializable]
    [XmlType(TypeName = "LineStringType", Namespace = "http://www.opengis.net/kml/2.2")]
    ...
    public class LineString : GeometryBase
    {
        ...
        private KmlObjectBase[] lineStringObjectExtensionGroupField;
        ...
        public KmlObjectBase[] LineStringObjectExtensionGroup
        {
