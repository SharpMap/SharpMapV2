...
namespace SharpMap.Entities.Ogc.Kml
{
    /// <remarks/>
    [Serializable]
    [XmlType(TypeName = "PolyStyleType", Namespace = "http://www.opengis.net/kml/2.2")]
    [XmlRoot("PolyStyle", Namespace = "http://www.opengis.net/kml/2.2", IsNullable = false)]
    public class PolyStyle : ColorStyleBase
    {
        ...
        private KmlObjectBase[] polyStyleObjectExtensionGroupField;
        ...
        public KmlObjectBase[] PolyStyleObjectExtensionGroup
        {
