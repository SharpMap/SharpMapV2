...
namespace SharpMap.Entities.Ogc.Kml
{
    ...
    [Serializable]
    [XmlType(TypeName = "AbstractGeometryType", Namespace = "http://www.opengis.net/kml/2.2")]
    public abstract class GeometryBase : KmlObjectBase
    {
        private KmlObjectBase[] _kmlGeometryObjectExtensionGroupField;
        ...
        public KmlObjectBase[] KmlGeometryObjectExtensionGroup
        {
            get { return _kmlGeometryObjectExtensionGroupField; }
            set { _kmlGeometryObjectExtensionGroupField = value; }
        }
    }
}