        ...
        : XPathQueryManager_Decorator, IXPathQueryManager
    {
        ...
        public override XPathExpression Compile(string xPath)
        {
            ...
            else
            {
                ...
                _CompiledExpressions.Add(xPath, (expr = XPathQueryManager.Compile(xPath)));
                return expr;
            }
        }
        ...
        {
            return new XPathQueryManager_CompiledExpressionsDecorator(XPathQueryManager.Clone());
        }
        ...
        {
            IXPathQueryManager xPathQueryManager = XPathQueryManager.GetXPathQueryManagerInContext(xPath);
        ...
        {
            return XPathQueryManager.GetContextOfNextNode();
        }
        ...
        {
            return XPathQueryManager.GetContextOfNode(index);
        }
