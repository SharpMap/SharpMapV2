...
namespace SharpMap.Data.Providers.SpatiaLite2
{
    ...
    /// </summary>
    public class SpatiaLite2_Exception : SharpMapDataException
    {
        public SpatiaLite2_Exception() : base() { }
        public SpatiaLite2_Exception(String message) : base(message) { }
        public SpatiaLite2_Exception(String message, Exception inner) : base(message, inner) { }
        public SpatiaLite2_Exception(SerializationInfo info, StreamingContext context)
            : base(info, context) { }
    }
}
