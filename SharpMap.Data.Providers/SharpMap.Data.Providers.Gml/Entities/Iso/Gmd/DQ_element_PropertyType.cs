...
{
    [Serializable, XmlInclude(typeof (AbstractDQ_positionalAccuracy_Type)),
     XmlInclude(typeof (AbstractDQ_temporalAccuracy_Type)), XmlInclude(typeof (AbstractDQ_thematicAccuracy_Type)),
     XmlType(TypeName = "DQ_element_PropertyType", Namespace = "http://www.isotc211.org/2005/gmd"),
     XmlInclude(typeof (AbstractDQ_logicalConsistency_Type)), XmlInclude(typeof (AbstractDQ_completeness_Type))]
