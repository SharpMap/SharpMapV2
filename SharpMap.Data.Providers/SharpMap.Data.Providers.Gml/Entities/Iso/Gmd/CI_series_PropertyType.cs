namespace SharpMap.Entities.Iso.Gmd
{
    ...
    [Serializable, XmlType(TypeName="CI_series_PropertyType", Namespace="http://www.isotc211.org/2005/gmd")]
    public class CI_series_PropertyType
    {
        ...
        [XmlIgnore]
        private SharpMap.Entities.Iso.Gmd.CI_series _cI_Series;
        [XmlIgnore]
        ...
        {
            this.CI_series.MakeSchemaCompliant();
        }
        ...
        [XmlElement(Type=typeof(SharpMap.Entities.Iso.Gmd.CI_series), ElementName="CI_series", IsNullable=false, Form=XmlSchemaForm.Qualified, Namespace="http://www.isotc211.org/2005/gmd")]
        public SharpMap.Entities.Iso.Gmd.CI_series CI_series
        {
            get
            {
                return this._cI_Series;
            }
            set
            {
                this._cI_Series = value;
            }
        }
