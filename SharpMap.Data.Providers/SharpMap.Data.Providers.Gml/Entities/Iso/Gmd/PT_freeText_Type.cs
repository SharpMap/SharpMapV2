...
{
    [Serializable, XmlType(TypeName = "PT_freeText_Type", Namespace = "http://www.isotc211.org/2005/gmd")]
    public class PT_freeText_Type : AbstractObjectType
    {
        ...
        public List<LocalisedCharacterStringPropertyType> TextGroup
        {
            get
            {
                if (_textGroup == null)
                {
                    _textGroup = new List<LocalisedCharacterStringPropertyType>();
                }
                return _textGroup;
            }
        ...
        public override void MakeSchemaCompliant()
        {
            ...
            foreach (LocalisedCharacterStringPropertyType _c in TextGroup)
            {
        ...
        public LocalisedCharacterStringPropertyType Remove(int index)
        {
