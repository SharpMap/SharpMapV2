...
{
    [Serializable, XmlInclude(typeof (DQ_temporalValidity_Type)),
     XmlType(TypeName = "DQ_temporalAccuracy_PropertyType", Namespace = "http://www.isotc211.org/2005/gmd"),
     XmlInclude(typeof (DQ_accuracyOfATimeMeasurement_Type)), XmlInclude(typeof (DQ_temporalConsistency_Type))]
