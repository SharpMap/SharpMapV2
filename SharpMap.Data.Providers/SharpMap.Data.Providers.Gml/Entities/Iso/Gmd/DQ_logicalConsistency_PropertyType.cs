...
namespace SharpMap.Entities.Iso.Gmd
{
    [Serializable,
     ...
     XmlInclude(typeof (DQ_topologicalConsistency_Type)), XmlInclude(typeof (DQ_domainConsistency_Type)),
     XmlInclude(typeof (DQ_formatConsistency_Type)), XmlInclude(typeof (DQ_conceptualConsistency_Type))]
