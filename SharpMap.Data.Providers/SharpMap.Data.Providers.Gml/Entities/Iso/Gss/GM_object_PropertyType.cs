...
namespace SharpMap.Entities.Iso.Gss
{
    [Serializable, XmlInclude(typeof (AbstractGeometricPrimitiveType)), XmlInclude(typeof (GeometricComplexType)),
     XmlType(TypeName = "GM_object_PropertyType", Namespace = "http://www.isotc211.org/2005/gss"),
     XmlInclude(typeof (AbstractGeometricAggregateType)), XmlInclude(typeof (GridType))]
