...
{
    [Serializable, XmlInclude(typeof (TopoSolidType)),
     XmlType(TypeName = "TopoPrimitiveMemberType", Namespace = "http://www.opengis.net/gml/3.2"),
     XmlInclude(typeof (FaceType)), XmlInclude(typeof (NodeType)), XmlInclude(typeof (EdgeType))]
