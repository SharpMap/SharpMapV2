...
{
    [Serializable, XmlType(TypeName = "SurfacePropertyType", Namespace = "http://www.opengis.net/gml/3.2"),
     XmlInclude(typeof (PolygonType)), XmlInclude(typeof (SurfaceType)), XmlInclude(typeof (OrientableSurfaceType)),
