...
namespace SharpMap.Data.Providers.PostGis
{
    ...
    /// </summary>
    public class PostGisException : SharpMapDataException
    {
        public PostGisException()
        {
        }

        public PostGisException(String message) : base(message)
        {
        }

        public PostGisException(String message, Exception inner) : base(message, inner)
        {
        }

        public PostGisException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
